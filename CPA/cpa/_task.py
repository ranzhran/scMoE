...
class CPATrainingPlan(TrainingPlan):
    def __init__(
        ...
        self.metrics = ['recon_loss', 'KL', 'info',
    ...
    def training_step(self, batch, batch_idx):
        ...
        recon_loss, kl_loss, info_loss = self.module.loss(
            tensors=batch,
        ...
        if self.do_start_adv_training:
            ...
            if self.adv_steps is None:
                ...
                loss = recon_loss + self.kl_weight * kl_loss + 0.1 * info_loss - self.adv_lambda * adv_results['adv_loss']
            ...
            loss = recon_loss + self.kl_weight * kl_loss + 0.1 * info_loss
        ...
        results.update({'info': info_loss.item()})
    ...
    def training_epoch_end(self, outputs):
        ...
        self.log("acc_perts", self.epoch_history['acc_perts'][-1], prog_bar=True)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        adv_results1 = self.adversarial_loss(tensors=batch,
                                            z_basal=z_basal,
                                            mixup_lambda=mixup_lambda,
                                            compute_penalty=False)
        ...
        results = adv_results
        results.update({'acc_pert': adv_results1['acc_perts']})
        results.update({'r2_mean': r2_mean, 'r2_var': r2_var})
    ...
    def validation_epoch_end(self, outputs):
        ...
        self.log('val_info', self.epoch_history['info'][-1], prog_bar=True)
        self.log('acc_perts', self.epoch_history['acc_perts'][-1], prog_bar=True)
        ...
        if self.current_epoch % self.n_epochs_verbose == self.n_epochs_verbose - 1:
            ...
            print(f'acc_perts = {self.epoch_history["acc_perts"][-1]}')
