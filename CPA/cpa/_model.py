    ...
    **hyper_params:
    ...
    def __get_rdkit_embeddings(
        ...
        for smiles in smiles_list:
            ...
            fps = AllChem.GetMorganFingerprintAsBitVect(mol, 2, nBits=2048) #2048
    ...
    def custom_predict(
        ...
        #     print(self.module.covars_encoder.keys())
        #     print('====================')
        ...
        if covars_to_add is None:
            covars_to_add = []
        # for covar in covars_to_add:
        #     print(self.module.pert_encoder.keys())
        #     print('====================')
        #     assert covar in self.module.pert_encoder.keys(
        #     ), f"covariate {covar} not found in learned covariates"
        ...
        latent_x_pred = x_pred

        adata.obsm[f"{self.__class__.__name__}_pred"] = latent_x_pred
        return latent_x_pred

    @torch.no_grad()
    def get_pert_embeddings(self, dosage=3.0, pert: Optional[str] = None): #1.0
